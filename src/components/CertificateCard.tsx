...
function CertificateCard() {
  ...
  return (
    <Link
      ...
      className="relative col-start-4 row-start-3 flex w-full max-w-md justify-center overflow-hidden rounded-2xl bg-[#0B0D0F] p-5 shadow-2xl shadow-[#FFFF01]/30 transition duration-300 ease-in-out hover:scale-[103%] hover:shadow-[#FFFF01]/50 md:max-w-lg"
