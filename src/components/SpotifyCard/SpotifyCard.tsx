...
export default function SpotifyCard() {
  ...
  return (
    <section className="flex w-full max-w-md flex-col items-center overflow-hidden rounded-2xl bg-[#fffa] p-4 pb-6 backdrop-blur-2xl md:max-w-lg md:flex-col md:items-start">
