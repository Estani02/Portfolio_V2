...
function EmailCard() {
  return (
    <Link
      aria-label="Linkedin"
      className="relative flex flex-col items-center justify-center gap-3 rounded-2xl bg-gradient-to-br from-[#C62828]/80 to-[#C62828]/30 p-5 shadow-2xl shadow-[#C62828]/30 transition duration-300 ease-in-out hover:scale-[103%] hover:shadow-[#C62828]/50"
