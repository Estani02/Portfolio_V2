...
function WeatherCard() {
  ...
  return (
    <>
      {isLoading ? (
        <div className="col-span-2 row-start-4 w-full rounded-2xl bg-yellow-400">
          <p>Loading...</p>
        </div>
      ) : (
        ...
        col-span-2 row-start-4 flex  w-full justify-around overflow-hidden rounded-2xl bg-clip-padding p-6 text-white backdrop-blur-sm flex-row-reverse items-center`}>
        {/* <div> */}
          {isDaytime ? <Sun /> : <Moon />}
